document.addEventListener('DOMContentLoaded', function () {
    ...
    const publications = [
        ...
        { topic: 'astronomy', authors: [me, 'Jorge Martinez-Palomera', 'Karim Pichara', 'Pablo Huijse', 'Márcio Catelan'] },
        { topic: 'health', authors: ['Joris Van de Klundert', me, 'Marcelo Olivares', 'Laura Pengel', 'A. de Weerd'] },
        { topic: 'health', authors: ['Joris Van de Klundert', 'H. De Vries', me, 'N. Valdes', 'Felipe Simon'] },
        { topic: 'optimization', authors: ['Cristian Sotelo', 'R. Santa-Gonzalez', me, 'Carlos Monardes-Concha'] },
        { topic: 'analytics', authors: ['Fernando Montenegro-Dos Santos', me, 'Carlos Monardes-Concha', 'Alfredo Candia-Véjar', 'M. Nagano'] },
        { topic: 'astronomy', authors: [me, 'Karim Pichara', 'Pablo Huijse', 'Márcio Catelan', 'Domingo Mery'] },
        { topic: 'astronomy', authors: ['Y Salinas', 'Karim Pichara', 'Rafael Brahm', me, 'Domingo Mery'] },
        { topic: 'analytics', authors: ['J Moya', me, 'C. Tamarasco', 'C Astudillo', 'Alfredo Candia-Véjar'] },
        { topic: 'optimization', authors: ['Z Govea', me, 'Alfredo Candia-Véjar'] },
        { topic: 'astronomy', authors: [me, 'Karim Pichara', 'Pablo Huijse', 'Márcio Catelan', 'Domingo Mery'] },
        { topic: 'optimization', authors: [me, 'Nelson Maculan', 'Alfredo Candia-Véjar'] },
        { topic: 'optimization', authors: ['D Revillot', me, 'Eduardo Álvarez-Miranda'] },
        { topic: 'optimization', authors: [me, 'Alfredo Candia-Véjar', 'C Astudillo', 'M. Bardeen'] },
